...
a persistence unit "universidadesPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "universidades/pom.xml":
...
artifact ("universidades.war") is already built. You can build
