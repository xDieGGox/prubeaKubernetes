...
COPY target/universidades.war ${JBOSS_HOME}/standalone/deployments/

# Crear usuario de WildFly
RUN /opt/jboss/wildfly/bin/add-user.sh diego diego --silent

# Definir variables de entorno
#EN DS_URI jdbc estaba 192.168.1.13:5432 para lo de proxmox
#EN DS_URI jdbc estaba postgres tambien esto para lo del conexion con otra cosa
